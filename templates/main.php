            ...
            <?php foreach ($ads as $key => $item): ?>
                <li class="lots__item lot">
                    <div class="lot__image">
                        <img src="<?=htmlspecialchars($item['url']); ?>" width="350" height="260" alt="<?=htmlspecialchars($item['name']); ?>">
                    </div>
                    <div class="lot__info">
                        ...
                        <div class="lot__state">
                            ...
                            <div class="lot__timer timer<?php if(array_sum(get_time($item['time_finish'])) < 60): ?> timer--finishing<?php endif;?> ">
                                <?= implode(":", get_time($item['time_finish'])) ?>
                            </div>
                        </div>
                    </div>
                </li>
